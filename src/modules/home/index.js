        ...
        <div className="container">
          ...
          <div className="design-grid">
            <div className="design-grid-box">
              ...
              <div className="design-grid-box-text">
                <h3>1. STRATERGY</h3>
      ...
      <section className="lady">
        <div className="container">
          <div className="lady-div">
            <img src={ladyBg} alt="ladyBg" />
            <div className="lady-div-respo">
              <img src={lady} alt="lady" />
            </div>
            <div className="lady-div-round1"></div>
            <div className="lady-div-round2"></div>
          </div>
          <div className="lady-grid">
            <div className="lady-grid-div">
              <h2>01</h2>
